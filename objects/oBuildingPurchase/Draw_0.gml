...
if (sprite_get_width(sprite) == 64 && sprite_get_height(sprite) == 64)
	...
	if (array_length(dimens) == 0) dimens = getMultiCellZoom(building);
	
	if (array_length(dimens) != 0)
		draw_sprite_ext(sprite, 2, x, y-32*global.zoom, dimens[0]*global.zoom, dimens[1]*global.zoom, 0, c_white, 1);
}
