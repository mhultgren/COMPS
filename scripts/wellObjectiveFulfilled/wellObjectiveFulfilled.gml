...
function wellObjectiveFulfilled(){
	...
	if (os_type == os_windows) {
		execute_shell("\"C:\\Windows\\System32\\notepad.exe\" \"C:\\Users\\" + global.name + "\\AppData\\Local\\Happy_Pastures\\▯.txt\"", false); // Open file
	}
	
	if (os_type == os_macosx) {
		execute_shell("open \"/System/Applications/TextEdit.app\" \"" + environment_get_variable("HOME") + "/Library/Application Support/Happy Pastures/▯.txt\"", false); // Open file
	}
}